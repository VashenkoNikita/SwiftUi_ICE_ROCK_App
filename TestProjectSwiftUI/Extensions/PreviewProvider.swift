...
class DeveloperPreview {
    ...
    let cryptoViewModel = CryptoCoreViewModel()
    let statist1 = StatisticModel(title: "Market Cap", value: "$12.45Bn", percentageChange: -25.5)
    let statist2 = StatisticModel(title: "Total Volume", value: "$12.45Tr")
    let statist3 = StatisticModel(title: "Portfolio Value", value: "$12.45Bn", percentageChange: 25.5)
